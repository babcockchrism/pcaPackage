...
#' @param data matrix of data set to be analyzed
#' @param eigen_opt determines number of principal components to calculate; if left blank, the function will use the optimal number of components determined by the "threshold" argument
#' @param threshold  percent of variance the minimum number of principal components must explain
#' @keywords pca principal component analysis eigen eigenvalue eigenvalues eigenvector eigenvectors
#' @export
#' @examples
#' pca(iris, eigen_opt = NA, threshold = 85)
